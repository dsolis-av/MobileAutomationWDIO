...
public class BottomBarNavigationTest extends BaseTest {
    ...
    @Test(testName = "Navigate through the bottom bar options")
    public void navigationTest(){
        ...
        //Go to Webview screen and assert home scroll view is visible
        ...
        //Go to Login screen and assert home scroll view is visible
        ...
        //Go to Forms screen and assert home scroll view is visible
        ...
        //Go to Swipe screen and assert home scroll view is visible
        ...
        //Go to Drag screen and assert home scroll view is visible
        ...
        //Check all assertion to check if anything failed
